...
public enum DogBreed implements AnimalBreed {
    ...
    BRACCO_ITALIANOIS("Bracco Italiano"),
    ...
    CZECHOSLOVAKIAN_VLCIAK("Czechoslovakian Vlciak"),
    ...
    ENGLISH_SETTLER("English Settler"),
    ...
    JAPANESE_AKITAINU("Japanese Akitainu"),
    ...
    // "N"
    NEOPOLITAN_MASTIFF("Neopolitan Mastiff"),
    ...
    // "P"
    PAPILLON("Papillon"),
    PARSON_RUSSEL_TERRIER("Parson Russel Terrier"),
    ...
    ROMANIAN_CARPATHIAN_SHEPHERD("Romanian Carpathian Shepherd"),
    ...
    SALUKI("Saluki"),
    SAMOYED("Samoyed"),
    SCHAPENDOES("Schapendoes"), // Dutch Sheep Dog
    ...
    SLOUGHI("Sloughi"),  // Arabian Greyhound
