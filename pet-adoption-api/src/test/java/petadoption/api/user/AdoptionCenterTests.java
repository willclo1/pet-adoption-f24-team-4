...
public class AdoptionCenterTests {
    ...
    void testGetAdoptionCenterById() {
        AdoptionCenter center = new AdoptionCenter("Furry Friends Shelter");
    ...
    @Test
    void testAddSampleAdoptionCenters() {
        adoptionCenterService.addSampleAdoptionCenters();

        List<AdoptionCenter> centers = adoptionCenterService.getAllAdoptionCenters();


        assertEquals(10, centers.size(), "There should be 10 sample adoption centers in the database");
        assertTrue(centers.stream().anyMatch(c -> c.getCenterName().equals("Happy Paws Rescue")), "Happy Paws Rescue should exist in the list of centers");
    }

    @Test
    void testSaveAdoptionCenterWithLongDescription() {
        AdoptionCenter center = new AdoptionCenter("Compassionate Critters");
    ...
    void testGetAllAdoptionCenters() {
        AdoptionCenter center1 = new AdoptionCenter("Pawtastic Haven");
        center1.setBuildingAddress("123 Main St, Paw City, NY");
        center1.setDescription("A haven for paw-some pets.");

        AdoptionCenter center2 = new AdoptionCenter("Forever Home Animal Rescue");
